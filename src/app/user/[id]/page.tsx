...
function BoothById() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] bg-gradient-to-br from-orange-50 to-orange-100 py-12 h-screen">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full flex flex-col items-center border border-green-100">
        <div className="w-24 h-24 rounded-full bg-orange-200 flex items-center justify-center text-4xl font-bold text-orange-700 shadow mb-6">
          {avatar}
        </div>
        <div className="flex w-full justify-between items-center mb-2">
          <h2 className="text-2xl font-extrabold text-[#BA400B] flex items-center gap-2">
        ...
        {successMsg && (
          <div className="bg-green-100 text-green-700 rounded-lg px-4 py-2 mb-2 w-full text-center">
            {successMsg}
          </div>
        )}
        {errorMsg && (
          <div className="bg-red-100 text-red-700 rounded-lg px-4 py-2 mb-2 w-full text-center">
            {errorMsg}
          </div>
        )}
        {editMode ? (
        ...
        <button
          onClick={() => router.back()}
          className="mt-8 px-6 py-2 rounded-lg bg-[#BA400B] hover:bg-orange-900 text-white font-bold shadow transition-all text-base cursor-pointer"
        >
