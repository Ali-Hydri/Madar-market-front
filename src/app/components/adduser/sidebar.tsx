...
//       <div
//         className={`fixed top-0 right-0 w-64 h-screen bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
//           isOpen ? "translate-x-0" : "translate-x-full"
//         }`}
//       >
//         <div className="p-4 flex justify-between items-center border-b border-green-600 text-green-600">
...
//         </div>
//         <nav className="p-4">
//           <ul className="space-y-1 text-[#4C4C4C] text-[15px]">
//             <li>
//               <a
//                 href="/dashboard"
//                 className="block hover:bg-green-100 p-2 rounded-l"
//               >
//                 خانه
//               </a>
//             </li>
...
//             </li>
//             <li>
//               <a href="/dashboard/setting" className="block hover:bg-green-100 p-2 rounded-l">
//                 تنظیمات
//               </a>
//             </li>
//             <li>
