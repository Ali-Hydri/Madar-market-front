          ...
          <tbody>
            {users.length === 0 ? (
              ...
              users.map((user, idx) => (
                <tr
                  key={user.id}
                  className="bg-gray-50 hover:bg-green-50 transition rounded-lg shadow-sm"
                >
...
function UsersPageContent() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 bg-gradient-to-br from-green-50 to-green-100 min-h-screen flex flex-col gap-8">
      {/* Success Popup */}
      {successPopup.show && (
        <SuccessPopup
